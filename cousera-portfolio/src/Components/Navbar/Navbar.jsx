  ...
  return (
    <div className='navbar'>
        ...
        <ul className="nav-menu">
            ...
            <li><AnchorLink className='anchor_link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Portfolio</p></AnchorLink>{menu==="work"?<img src={underline} alt=''/>:<></>}</li>
        ...
        <div className='nav-connect'><AnchorLink className='anchor_link' offset={50} href='#contact'>Connecct With Me</AnchorLink></div>
    </div>
  )
}
